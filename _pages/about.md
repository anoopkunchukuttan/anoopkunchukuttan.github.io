...
Previously, I was a Principal Applied Researcher in the Azure AI Platform group in Hyderabad, India with my research focussing on multilingual machine translation and automatic speech recognition.

My research interests include multilingual learning and LLMs, post-training of LLMs, reasoning and evaluation in LLMs, representation learning, NLP for related languages, machine translation, and transliteration. 

I completed my Ph.D. in 2018 at the [Department of Computer Science and Engineering](http://www.cse.iitb.ac.in), [IIT Bombay](http://www.iitb.ac.in). I did my research under the guidance of the [Late Prof. Pushpak Bhattacharyya](http://www.cse.iitb.ac.in/~pb) at the [Center for Indian Language Technology](http://www.cfilt.iitb.ac.in). My doctoral research work explored various facets of machine translation and transliteration between related languages.
...
<li> <i>04 May 2026</i>: Major Career Update! I have joined Bodhan AI as Vice-President (Research) to lead the educational AI and Indian language technology research. Bodhan AI is the Center of Excellence for AI in Education, based in IIT Madras, supported by the Govt. of India to build the Educational AI Stack for India as a Digitial Public Good. Bodhan AI Lab does open research and open models to further the Indian langauge technology ecosystem and the use of AI in education. </li>
